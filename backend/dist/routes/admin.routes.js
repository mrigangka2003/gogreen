...
// 📌 Accounts
router.get("/accounts", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("GET_ALL_ACCOUNTS"), admin_controller_1.default.getAllAccounts);
router.get("/accounts/:userId/bookings", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("GET_BOOKING_HISTORY"), admin_controller_1.default.getBookingHistory);
router.delete("/accounts/:id", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("DELETE_ACCOUNT"), admin_controller_1.default.deleteAccount);
router.patch("/accounts/:id", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("CREATE_ORG_EMP"), admin_controller_1.default.updateAccount);
...
router.get("/bookings", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("VIEW_ALL_BOOKINGS"), admin_controller_1.default.getAllBookings);
router.patch("/bookings/assign", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("UPDATE_ASSIGN_BOOKING"), admin_controller_1.default.updateAssignBooking);
...
// 📌 Profile
router.get("/profile", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("GET_PROFILE_SELF"), admin_controller_1.default.getProfileSelf);
router.patch("/profile", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("UPDATE_PROFILE_SELF"), admin_controller_1.default.updateProfileSelf);
router.delete("/profile", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("DELETE_PROFILE_SELF"), admin_controller_1.default.deleteProfileSelf);
// 📌 Services
router.get("/services", service_controller_1.default.getServices);
router.get("/services/all", auth_1.authMiddleware, (0, rbac_1.requirePermissions)("VIEW_ALL_BOOKINGS"), service_controller_1.default.getAllServices);
