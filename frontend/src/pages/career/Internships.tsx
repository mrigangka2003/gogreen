...
const Internships: React.FC = () => {
    ...
    const internships: Internship[] = [
        {
            ...
            type: "Full-time",
            description: "Assist in building and improving GoGreen’s web applications using React and TypeScript. Great learning opportunity for freshers passionate about clean technology.",
        ...
        },
        {
            ...
            type: "Part-time",
            description: "Work with our marketing team to promote GoGreen’s eco-friendly solutions. Gain hands-on experience in social media, campaigns, and community engagement.",
        ...
        },
        {
            ...
            type: "Internship",
            description: "Support our HR team in recruitment, onboarding, and employee engagement initiatives. A great opportunity to learn HR practices in a growing green energy company.",
        ...
        },
        {
            ...
            type: "Part-time",
            description: "Help create blog posts, social media content, and articles to spread awareness about renewable energy and sustainable practices.",
        ...
        },
        {
            ...
            type: "Full-time",
            description: "Work closely with our operations team to manage EV fleet schedules, track resources, and ensure smooth field activities.",
    ...
    const handleApply = (internshipId: number, internshipTitle: string) => {
        alert(`Applied to ${internshipTitle}! ${internshipId}`);
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-6xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">Internship Search</h1>
                    <p className="text-gray-600">Find your next learning opportunity</p>
                </div>
                ...
                <div className="space-y-6">
                    {filteredInternships.length === 0 ? (
                        ...
                        filteredInternships.map((internship) => (
                            <div key={internship.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 p-6">
